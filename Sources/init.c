...
//----------------------------------------------------------------------------
// Init_random_generator : set init state of  pseudo random number generator
// ============
//
// Parameters
//      None
//
// Notes
//		Set zero parameters now. Update with some entropy at a later time.

void Init_random_generator(void) {

	sys_mode = INITIALISING;
	init_prng(0, 0, 0);
}
